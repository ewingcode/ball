package com.ewing.order.common.contant;
...
public class SysParamCode {
	 ...
	 * 资源是否上架
	 */
	public final static String RES_ONLINE_TYPE = "RES_ONLINE_TYPE";
	/**
	 * 资源热门类型
	 */
	public final static String RES_HOT_TYPE = "RES_HOT_TYPE";
	 ...
	 * 配送方式
	 */
	public final static String CARRY_WAY = "CARRY_WAY";
	
	/**
	 * 资源运费类型
	 */
	public final static String RES_CARRYTYPE = "RES_CARRYTYPE";
}
